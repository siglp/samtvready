...
Batch conversion needs list of full path filenames to convert / check. See file_list_sample.txt. You can generate this file with find or create it manually or what ever you want. You can also create cron for periodically check and so on.
opt/samtvready/samtvready.conf
It's up to you :-).